...
backprop <- function(input, target, input.to.hidden.weights, hidden.to.output.weights){
  ...
  #has to initialize at 0 for the recursion in the for loop to work
